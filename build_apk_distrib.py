...
REQUIRED_FILES = [
    "main.py",
    "bluetooth_backend.py",
    "database.py",
    "crypto.py",
    "buildozer.spec"
]
APK_OUTPUT_DIR = os.path.join(PROJECT_DIR, "bin")
ICON_FILE = os.path.join(ASSETS_DIR, "avatar.png")
...
def ensure_assets():
    ...
    if not os.path.isfile(ICON_FILE):
        ...
        try:
            ...
            d.ellipse([32,32,96,96], fill="white")
            img.save(ICON_FILE)
        except ImportError:
            # Si PIL non installé, crée un PNG vide
